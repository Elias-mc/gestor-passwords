    ...
    <main className="flex-1 overflow-y-auto">
      <div className="mx-auto max-w-6xl p-8">
        <header className="mb-8">
          ...
          <p className="mt-2 text-sm text-title-secondary transition-colors duration-300 dark:text-slate-400">
            Tus cuentas marcadas como favoritas, para acceder más rápido.
          </p>
        </header>

        {favorites.length === 0 ? (
          <div className="rounded-xl border border-border bg-background-secundary p-10 text-center transition-colors duration-300">
            <div className="mb-3  text-text-secondary transition-colors duration-300 flex justify-center">
              <IconStar />
            </div>
